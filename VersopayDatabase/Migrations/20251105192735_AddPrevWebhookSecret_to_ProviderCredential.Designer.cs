...
namespace VersopayDatabase.Migrations
{
    ...
    [Migration("20251105192735_AddPrevWebhookSecret_to_ProviderCredential")]
    partial class AddPrevWebhookSecret_to_ProviderCredential
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProviderCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProviderCredential", b =>
                {
                    b.HasOne("VersopayLibrary.Models.Usuario", "OwnerUser")
                        .WithMany()
